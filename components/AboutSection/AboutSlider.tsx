            ...
            <Swiper pagination={{ clickable: true }} modules={[Pagination]} className="mySwiper">
                {
                    SLIDER_PROPS.map(item => (
                        <SwiperSlide key={item.name}>
                            <div className="flex items-center flex-col gap-1 mt-10">
                                <div>
                                ...
                                <p className="text-second-text mb-10">“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse consequat orci sed nibh ultricies, eget sollicitudin quam consectetur.
